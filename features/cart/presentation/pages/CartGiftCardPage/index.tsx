      ...
      <div className="container">
        ...
        >
          <div className={styles.cart__content}>
            ...
            <CartProductsTable rows={gifts?.slice(0, 3)} />
          </div>
            ...
            <div className={styles.conclusion__info}>
              <div className={styles.info__block}>
                <div className={styles.block__row}>
                  <p className={styles.row__text}>1 ապրանքների գինը</p>
                  <p className={styles.row__price}>123.000 AMD</p>
                </div>
              </div>
            </div>
...
export default CartGiftCardPage;
