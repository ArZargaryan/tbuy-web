        ...
        <div className={cl.wrapper}>
          <div className={cl.wrapper__left}>
            <section className={cl.company}>
              ...
              >
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_269_45013)">
                    <path
              ...
              <Button variant="transparent" className={cl.company__report}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="19"
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_2038_13285)">
            ...
            <section className={cl.social}>
              <Button variant="transparent" className={cl.social__link}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="36"
                  height="36"
              ...
              <Button variant="transparent" className={cl.social__link}>
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_269_45023)">
                    <path
                      d="M18 36C27.9411 36 36 27.9411 36 18C36 8.05888 27.9411 0 18 0C8.05888 0 0 8.05888 0 18C0 27.9411 8.05888 36 18 36Z"
              ...
              <Button variant="transparent" className={cl.social__link}>
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_269_45030)">
                    <path
                      d="M18 36C27.9411 36 36 27.9411 36 18C36 8.05888 27.9411 0 18 0C8.05888 0 0 8.05888 0 18C0 27.9411 8.05888 36 18 36Z"
                      fill="#010201"
                    />
              ...
              <Button variant="transparent" className={cl.social__link}>
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_269_45058)">
                    <path
              ...
              <Button variant="transparent" className={cl.social__link}>
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_269_45063)">
                    <path
                      d="M18 36C27.9411 36 36 27.9411 36 18C36 8.05888 27.9411 0 18 0C8.05888 0 0 8.05888 0 18C0 27.9411 8.05888 36 18 36Z"
                      fill="#DA0000"
                    />
              ...
              <div className={cl.phone_modal__links}>
                ...
                <a href="" className={cl.phone_modal__link}>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clipPath="url(#clip0_269_45387)">
                      <path
                ...
                <a href="" className={cl.phone_modal__link}>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clipPath="url(#clip0_269_45412)">
                      <path
                        d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z"
